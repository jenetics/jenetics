...
public final class EvolvingImages extends JFrame {
    ...
    private void initComponents() {
        ...
        bestEvolutionResultPanel = new EvolutionResultPanel();
        currentevolutionResultPanel = new EvolutionResultPanel();
        engineParamPanel = new EngineParamPanel();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				EvolvingImagesCmd.writeImage(imageFile, ch, dim.width, dim.height);
    ...
    private EvolutionResultPanel bestEvolutionResultPanel;
    private javax.swing.JPanel buttonPanel;
    private EvolutionResultPanel currentevolutionResultPanel;
    private EngineParamPanel engineParamPanel;
