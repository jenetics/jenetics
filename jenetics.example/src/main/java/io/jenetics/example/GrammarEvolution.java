	...
	implements Problem<ScriptFunction, IntegerGene, Double>
{
	...
	public GrammarEvolution(final Sampling<Double> sampling) {
		_sampling = requireNonNull(sampling);
	}

	public GrammarEvolution(final List<Sample<Double>> samples) {
	...
	public static void main(final String[] args) {
		// 4*x^3 - 3*x^2 + x
		final var regression = new GrammarEvolution(SAMPLES);
