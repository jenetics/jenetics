...
public class PersistentObject<T> {
	...
	private static void init() {
		...
		put("PermutationChromosome[Byte]", nextBytePermutationChromosome(),
			...
			Readers.PermutationChromosome.reader(Reader.text().map(Byte::parseByte)));
		put("PermutationChromosome[Short]", nextShortPermutationChromosome(),
			Writers.PermutationChromosome.writer(),
			Readers.PermutationChromosome.reader(Reader.text().map(Short::parseShort)));
		put("PermutationChromosome[Integer]", nextIntegerPermutationChromosome(),
			Writers.PermutationChromosome.writer(),
			Readers.PermutationChromosome.reader(Reader.text().map(Integer::parseInt)));
		put("PermutationChromosome[Long]", nextLongPermutationChromosome(),
			Writers.PermutationChromosome.writer(),
			Readers.PermutationChromosome.reader(Reader.text().map(Long::parseLong)));
		put("PermutationChromosome[Float]", nextFloatPermutationChromosome(),
			Writers.PermutationChromosome.writer(),
			Readers.PermutationChromosome.reader(Reader.text().map(Float::parseFloat)));
		put("PermutationChromosome[Double]", nextDoublePermutationChromosome(),
			Writers.PermutationChromosome.writer(),
			Readers.PermutationChromosome.reader(Reader.text().map(Double::parseDouble)));
		put("PermutationChromosome[Character]", nextCharacterPermutationChromosome(),
			Writers.PermutationChromosome.writer(),
			Readers.PermutationChromosome.reader(Reader.text().map(s -> s.charAt(0))));
		put("PermutationChromosome[String]", nextStringPermutationChromosome(),
			Writers.PermutationChromosome.writer(),
			Readers.PermutationChromosome.reader(Reader.text()));
		...
		put("Genotype[EnumGene[Byte]]", nextGenotypeEnumGeneByte(),
			...
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text().map(Byte::parseByte))));
		put("Genotype[EnumGene[Character]]", nextGenotypeEnumGeneCharacter(),
			Writers.Genotype.writer(Writers.PermutationChromosome.writer()),
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text().map(s -> s.charAt(0)))));
		put("Genotype[EnumGene[Short]]", nextGenotypeEnumGeneShort(),
			Writers.Genotype.writer(Writers.PermutationChromosome.writer()),
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text().map(Short::parseShort))));
		put("Genotype[EnumGene[Integer]]", nextGenotypeEnumGeneInteger(),
			Writers.Genotype.writer(Writers.PermutationChromosome.writer()),
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text().map(Integer::parseInt))));
		put("Genotype[EnumGene[Long]]", nextGenotypeEnumGeneLong(),
			Writers.Genotype.writer(Writers.PermutationChromosome.writer()),
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text().map(Long::parseLong))));
		put("Genotype[EnumGene[Float]]", nextGenotypeEnumGeneFloat(),
			Writers.Genotype.writer(Writers.PermutationChromosome.writer()),
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text().map(Float::parseFloat))));
		put("Genotype[EnumGene[Double]]", nextGenotypeEnumGeneDouble(),
			Writers.Genotype.writer(Writers.PermutationChromosome.writer()),
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text().map(Double::parseDouble))));
		put("Genotype[EnumGene[String]]", nextGenotypeEnumGeneString(),
			Writers.Genotype.writer(Writers.PermutationChromosome.writer()),
			Readers.Genotype.reader(Readers.PermutationChromosome.reader(Reader.text())));
		...
		put("Genotypes[EnumGene[Integer]]", nextPopulationEnumGene(),
			...
			Readers.Genotypes.reader(Readers.PermutationChromosome.reader(Reader.text().map(Integer::parseInt))));
	}
	...
	public static EnumGene<Byte> nextEnumGeneByte() {
		return EnumGene.of(ISeq.of(() -> random.nextByte(random()), 5));
	}

	public static EnumGene<Character> nextEnumGeneCharacter() {
		return EnumGene.of(ISeq.of(() -> random.nextCharacter(random()), 5));
	}

	public static EnumGene<Short> nextEnumGeneShort() {
		return EnumGene.of(ISeq.of(() -> random.nextShort(random()), 5));
	}
	...
	public static EnumGene<String> nextEnumGeneString() {
		return EnumGene.of(ISeq.of(() -> random.nextString(random()), 5));
	}
	...
	public static PermutationChromosome<Byte> nextBytePermutationChromosome() {
		return PermutationChromosome.of(ISeq.of(() -> random.nextByte(random()), 15));
	}

	public static PermutationChromosome<Short> nextShortPermutationChromosome() {
		return PermutationChromosome.of(ISeq.of(() -> random.nextShort(random()), 15));
	}
	...
	public static PermutationChromosome<Character> nextCharacterPermutationChromosome() {
		return PermutationChromosome.of(ISeq.of(() -> random.nextCharacter(random()), 15));
	}

	public static PermutationChromosome<String> nextStringPermutationChromosome() {
		return PermutationChromosome.of(ISeq.of(() -> random.nextString(random()), 15));
	}
