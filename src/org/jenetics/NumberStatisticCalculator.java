 ...
 * @version $Id: NumberStatisticCalculator.java,v 1.1 2008-08-27 20:30:20 fwilhelm Exp $
 */
public class NumberStatisticCalculator<G extends Gene<?>, N extends Number<N>>
	extends StatisticCalculator<G, N>
{
	...
	public NumberStatistic<G, N> evaluate(final List<? extends Phenotype<G, N>> population) {
		...
		StackContext.enter();
		try {
			for (Phenotype<G, N> phenotype : population) {
				if (fitnessSum == null) {
					fitnessSum = phenotype.getFitness();
