...
http://jenetics.io[Jenetics] uses the _dieharder_ footnote:[http://www.phy.duke.edu/~rgb/General/dieharder.php[From Robert G. Brown]] (command line) tool for testing the randomness
...
the source file of the _LCG64ShiftRandom_ footnote:[https://github.com/jenetics/jenetics/blob/master/org.jenetics/src/main/java/org/jenetics/util/LCG64ShiftRandom.java[Full report]] class.
