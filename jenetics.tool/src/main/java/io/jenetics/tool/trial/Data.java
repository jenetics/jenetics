...
public final class Data implements Serializable {
	...
	public SampleSummary summary() {
		return _samples.stream()
			...
			.collect(SampleSummary.toSampleSummary(sampleSize()));
	}
	...
	public static final Writer<Data> WRITER = Writer.elem(
		"data",
		Writer.attr("name").map(Data::getName),
		Writer.elems(Sample.WRITER).map(d -> d._samples)
	);
