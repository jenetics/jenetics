...
The library is fully documented ([javadoc](http://jenetics.io/javadoc/org.jenetics/3.9/index.html)) and comes with an user manual ([pdf](http://jenetics.io/manual/manual-3.9.0.pdf)).
