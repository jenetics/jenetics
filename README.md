...
* **[jenetics](./jentics)**: This project contains the source code and tests for the Jenetics core-module.
* **[jenetics.ext](./jentics.ext)**: This module contains additional _non_-standard GA operations and data types.
* **[jenetics.prog](./jentics.prog)**: The modules contains classes which allows to do genetic programming (GP). It seamlessly works with the existing `EvolutionStream` and evolution `Engine`.
* **[jenetics.xml](./jentics,xml)**: XML marshalling module for the _Jenetics_ base data structures.
