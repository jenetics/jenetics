 ...
 * about the <em>static</em> type of the property and the <em>static</em> type
...
public sealed interface Value {
	...
	final class Single implements Value {
		...
		/**
		 * Return a new single description value from the given bean component.
		 *
		 * @param component the bean component
		 * @return a new single description value
		 */
		public static Single of(final StructType.Component component) {
			return new Single(
				component.enclosure(),
				component.value(),
	...
	final class Indexed implements Value {
		...
		/**
		 * Return the setter function of the <em>indexed</em> property, if the
		...
		@Override
		public boolean equals(final Object obj) {
			return obj == this || obj instanceof Indexed i && enclosure.equals(i.enclosure) && value.equals(i.value);
		}
