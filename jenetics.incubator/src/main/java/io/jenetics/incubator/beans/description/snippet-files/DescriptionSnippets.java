...
final class DescriptionSnippets {
	...
	static class DescriptionsSnippets {
		...
		static void listPathValue() {
			...
			Descriptions.list(PathValue.of(io.jenetics.incubator.beans.Path.of("book"), Book.class))
				.forEach(System.out::println);
			// @end
		}
		...
		static void walkPathValue() {
			...
			Descriptions.walk(PathValue.of(io.jenetics.incubator.beans.Path.of("library"), Book.class))
				.forEach(System.out::println);
			// @end
		}
