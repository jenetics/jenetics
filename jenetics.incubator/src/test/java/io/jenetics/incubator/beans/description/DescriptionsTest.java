...
public class DescriptionsTest {
	...
	public void extractLibrary() {
		...
		final var expected = """
			Description[path=library.books, type=java.util.List<io.jenetics.incubator.beans.model.Book>, enclosure=io.jenetics.incubator.beans.model.Library]
			Description[path=library.name, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Library]
			""".split("\n");
	...
	public void extractBook() {
		...
		final var expected = """
			Description[path=authors, type=java.util.List<io.jenetics.incubator.beans.model.Author>, enclosure=io.jenetics.incubator.beans.model.Book]
			Description[path=pages, type=int, enclosure=io.jenetics.incubator.beans.model.Book]
			Description[path=title, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Book]
			""".split("\n");
	...
	public void extractAuthor() {
		...
		final var expected = """
			Description[path=birthDate, type=java.time.LocalDate, enclosure=io.jenetics.incubator.beans.model.Author]
			Description[path=books, type=java.util.List<io.jenetics.incubator.beans.model.Book>, enclosure=io.jenetics.incubator.beans.model.Author]
			Description[path=forename, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Author]
			Description[path=surname, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Author]
			""".split("\n");
	...
	public void walkLibrary() {
		...
		final var expected = """
			Description[path=library.books, type=java.util.List<io.jenetics.incubator.beans.model.Book>, enclosure=io.jenetics.incubator.beans.model.Library]
			Description[path=library.books[0], type=io.jenetics.incubator.beans.model.Book, enclosure=java.util.List]
			Description[path=library.books[0].authors, type=java.util.List<io.jenetics.incubator.beans.model.Author>, enclosure=io.jenetics.incubator.beans.model.Book]
			Description[path=library.books[0].authors[0], type=io.jenetics.incubator.beans.model.Author, enclosure=java.util.List]
			Description[path=library.books[0].authors[0].birthDate, type=java.time.LocalDate, enclosure=io.jenetics.incubator.beans.model.Author]
			Description[path=library.books[0].authors[0].books, type=java.util.List<io.jenetics.incubator.beans.model.Book>, enclosure=io.jenetics.incubator.beans.model.Author]
			Description[path=library.books[0].authors[0].books[0], type=io.jenetics.incubator.beans.model.Book, enclosure=java.util.List]
			Description[path=library.books[0].authors[0].forename, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Author]
			Description[path=library.books[0].authors[0].surname, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Author]
			Description[path=library.books[0].pages, type=int, enclosure=io.jenetics.incubator.beans.model.Book]
			Description[path=library.books[0].title, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Book]
			Description[path=library.name, type=java.lang.String, enclosure=io.jenetics.incubator.beans.model.Library]
			""".split("\n");
