...
public class GenotypeTest extends ObjectTester<Genotype<DoubleGene>> {
	...
	public void factoryTest() {
		...
		assertEquals(factory.length(), gt.length());
		assertEquals(factory.getNumberOfGenes(), gt.getNumberOfGenes());
    ...
    public void numberOfGenes() {
		...
		assertEquals(genotype.getNumberOfGenes(), 32);
    }
	...
	public void newInstance() {
		...
		assertEquals(gt1.length(), gt2.length());
