...
public class PartiallyMatchedCrossoverTest {
	...
	public void crossover() {
		...
		final MSeq<Integer> alleles = MSeq.<Integer>ofLength(length).fill(factories.Int());
	...
	public void alterProbability(
		...
		final ISeq<Phenotype<EnumGene<Double>, Double>> population =
			TestUtils.newPermutationDoubleGenePopulation(ngenes, nchromosomes, npopulation);
