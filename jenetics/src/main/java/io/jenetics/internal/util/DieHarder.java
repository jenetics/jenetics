...
public final class DieHarder {
	...
	public static void main(final String[] args) throws Exception {
		if ( args.length < 1) {
			println("Usage: \n" +
				"   java DieHarder <random-class-name>");
			return;
		}
	...
	static final class Result {
		...
		public boolean equals(final Object obj) {
			return obj instanceof Result &&
				Equality.eq(testName, ((Result)obj).testName) &&
				Equality.eq(ntup, ((Result)obj).ntup) &&
				Equality.eq(tsamples, ((Result)obj).tsamples) &&
				Equality.eq(psamples, ((Result)obj).psamples) &&
				Equality.eq(pvalue, ((Result)obj).psamples) &&
				Equality.eq(assessment, ((Result)obj).assessment);
		}
