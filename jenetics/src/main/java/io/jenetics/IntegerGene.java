		...
		Serializable
{
	...
	public static IntegerGene of(final int min, final int max) {
		return of(random.nextInt(getRandom(), min, max), min, max);
	}
	...
	public static IntegerGene of(final IntRange range) {
		return of(random.nextInt(getRandom(), range.getMin(), range.getMax()), range);
	}
	...
	static ISeq<IntegerGene> seq(
		...
		return MSeq.<IntegerGene>ofLength(length)
			.fill(() -> new IntegerGene(random.nextInt(r, min, max), minimum, maximum))
			.toISeq();
	}
	...
	public IntegerGene newInstance() {
		return new IntegerGene(
			random.nextInt(getRandom(), _min, _max), _min, _max
		);
	}
