...
abstract class PRNG extends Random {
	 ...
	 *
	 * @see random#nextInt(java.util.Random, int, int)
	 */
	 ...
	 * @throws IllegalArgumentException if {@code min >= max}
	 *
	 * @see random#nextLong(java.util.Random, long, long)
	 */
	 ...
	 *
	 * @see random#nextLong(java.util.Random, long)
	 */
	 ...
	 *         than to {@code max}
	 *
	 * @see random#nextFloat(java.util.Random, float, float)
	 */
	 ...
	 *         than to {@code max}
	 *
	 * @see random#nextDouble(java.util.Random, double, double)
	 */
