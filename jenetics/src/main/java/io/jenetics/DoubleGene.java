		...
		Serializable
{
	...
	public static DoubleGene of(final double min, final double max) {
		return of(random.nextDouble(getRandom(), min, max), min, max);
	}
	...
	public static DoubleGene of(final DoubleRange range) {
		return of(random.nextDouble(getRandom(), range.getMin(), range.getMax()), range);
	}
	...
	static ISeq<DoubleGene> seq(
		...
		return MSeq.<DoubleGene>ofLength(length)
			.fill(() -> new DoubleGene(random.nextDouble(r, min, max), minimum, maximum))
			.toISeq();
	}
	...
	public DoubleGene newInstance() {
		return new DoubleGene(
			random.nextDouble(getRandom(), _min, _max), _min, _max
		);
	}
