...
public interface Codec<T, G extends Gene<?, G>> {
	 ...
	 * @since 3.3
	 *
	 * @see #combine(Codec, Codec, BiFunction)
	 *
	 ...
	 *            {@link #combine(Codec, Codec, BiFunction)} instead
	 */
	...
	static <A, B, T, G extends Gene<?, G>> Codec<T, G> of(
		...
		return combine(codec1, codec2, decoder);
	}
	 ...
	 *         empty
	 * @deprecated Will be removed in the next major version, use
	 *            {@link #combine(ISeq, Function)} instead
	 */
	@Deprecated(since = "8.1", forRemoval = true)
	static <T, G extends Gene<?, G>> Codec<T, G> of(
